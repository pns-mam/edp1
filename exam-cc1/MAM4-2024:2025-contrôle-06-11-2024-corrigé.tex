...
\noindent Universit\'e C\^ote d'Azur -- Polytech Nice Sophia 2024-2025\\
...
\end{array}
$$
pour les conditions aux limites $u(t,0)=u(t,1)=0$ %et l'in\'egalit\'e de Poincar\'e

par lin\'earit\'e de l'\'equation, la diff\'erence de deux solutions $u_1$ et $u_2$ v\'erifie le m\^eme probl\`eme avec donn\'ee initiale nulle, et la d\'ecroissance de l'\'energie implique que $E(t)\leq E(0)=0,\,\forall t$\\
...
et le principe du maximum discret est v\'erifi\'e sous la condition de stabilit\'e (CFL) pour la norme uniforme\\
...
\noindent pour $\displaystyle 1 - 16\,\nu \frac{\Delta t}{\Delta x^2} \sin^2\!\big( \pi k \Delta x \big) < 0$ les racines sont complexes conjugu\'ees et $\big| A_{1,2}(k) \big| < 1$

\noindent pour $\displaystyle 1 - 16\,\nu \frac{\Delta t}{\Delta x^2} \sin^2\!\big( \pi k \Delta x \big) \geq 0$ les racines sont r\'eelles (et positives) et aussi $\big| A_{1,2}(k) \big| < 1$
