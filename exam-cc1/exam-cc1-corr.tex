...
\noindent pour $\displaystyle 1 - 16\,\nu \frac{\Delta t}{\Delta x^2} \sin^2\!\big( \pi k \Delta x \big) < 0$ les racines sont complexes conjugu\'ees et $\big| A_{1,2}(k) \big| < 1$ puisque leur produit, qui est égal à leur module au carré, est strictement inférieur à $1$

\noindent pour $\displaystyle 1 - 16\,\nu \frac{\Delta t}{\Delta x^2} \sin^2\!\big( \pi k \Delta x \big) \geq 0$ les racines sont r\'eelles et on voit que $0 \leq A_1(k) \leq A_2(k) \leq 1$ dans la mesure où $ 2 \leq 3 \pm \sqrt{1-16\gamma} \leq 4$
