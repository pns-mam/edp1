...
\noindent (i) pour $\displaystyle 1 - 16\,\nu \frac{\Delta t}{\Delta x^2} \sin^2\!\big( \pi k \Delta x \big) < 0$ les racines sont complexes conjugu\'ees et $\big| A_{1,2}(k) \big| < 1$ puisque leur produit, qui est \'egal à leur module au carr\'e, est strictement inférieur \`a $1$
